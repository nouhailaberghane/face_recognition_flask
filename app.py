...
def generate_dataset(nbr):
    face_classifier = cv2.CascadeClassifier(
        r"C:\Users\haila\PycharmProjects\FlaskOpencv_FaceRecognition\venv\Lib\site-packages\cv2\data\haarcascade_frontalface_default.xml")
    ...
    while True:
        ...
        if face is not None:
            ...
            cv2.putText(face, str(count_img), (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
...
def train_classifier(nbr):
    dataset_dir = r"C:\Users\haila\Desktop\pjt f\dataset"
...
def face_recognition():  # generate frame by frame from camera
    ...
    faceCascade = cv2.CascadeClassifier(r"C:\Users\haila\PycharmProjects\FlaskOpencv_FaceRecognition\venv\Lib\site-packages\cv2\data\haarcascade_frontalface_default.xml")
    clf = cv2.face.LBPHFaceRecognizer_create()
